...
1. Fix V1 as described above, then triage V3 to V17 in `docs/build/04b-codex-validation.md`. Anything fixed goes through `/commit` on the same branch.
